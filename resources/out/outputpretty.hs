...
Load (ImmValue (0)) 4, 
Push 3, Load (ImmValue (1)) 7, Compute Add 3 7 3, WriteInstr 4 (IndAddr 3), Pop 3, 
Load (ImmValue (0)) 2, 
Push 3, Load (ImmValue (2)) 7, Compute Add 3 7 3, Store 2 (IndAddr 3), Pop 3, 
Load (ImmValue 30) 7, WriteInstr 7 (DirAddr 0), Jump (Abs 75) , 
Nop, 
Load (ImmValue (0)) 4, 
...
Load (ImmValue 1) 7, WriteInstr 7 (DirAddr 0), Jump (Abs 0), 
Nop, 
Load (ImmValue (0)) 2, 
...
Load (ImmValue (2)) 4, 
Push 3, Load (ImmValue (1)) 7, Compute Add 3 7 3, Store 4 (IndAddr 3), Pop 3, 
Push 3, Load (ImmValue (1)) 7, Compute Add 3 7 3, ReadInstr (IndAddr 3), Receive 2, Pop 3, 
Load (ImmValue (2)) 4, 
Compute NEq 2 4 2, 
