...
Load (ImmValue (0)) 4, 
Push 3, Load (ImmValue (3)) 7, Compute Add 3 7 3, WriteInstr 4 (IndAddr 3), Pop 3, 
Load (ImmValue (0)) 2, 
Push 3, Load (ImmValue (2)) 7, Compute Add 3 7 3, Store 2 (IndAddr 3), Pop 3, 
Load (ImmValue 29) 7, WriteInstr 7 (DirAddr 1), Jump (Abs 80) , 
Nop, 
Load (ImmValue (0)) 4, 
...
Compute Add 4 2 4, 
Push 3, Load (ImmValue (3)) 7, Compute Add 3 7 3, Store 4 (IndAddr 3), Pop 3, 
TestAndSet (DirAddr 6), Receive 7, Branch 7 (Rel 2), Jump (Rel (-3)), 
Load (ImmValue (3)) 2, 
Push 3, Load (ImmValue (3)) 7, Compute Add 3 7 3, WriteInstr 2 (IndAddr 3), Pop 3, 
Load (ImmValue 0) 7, WriteInstr 7 (DirAddr 6), 
Jump (Abs 35), 
Nop, 
Load (ImmValue (5)) 4, 
Push 3, Load (ImmValue (3)) 7, Compute Add 3 7 3, WriteInstr 4 (IndAddr 3), Pop 3, 
...
Load (ImmValue (2)) 4, 
Push 3, Load (ImmValue (3)) 7, Compute Add 3 7 3, WriteInstr 4 (IndAddr 3), Pop 3, 
Push 3, Load (ImmValue (3)) 7, Compute Add 3 7 3, ReadInstr (IndAddr 3), Receive 2, Pop 3, 
Load (ImmValue (2)) 4, 
Compute NEq 2 4 2, 
